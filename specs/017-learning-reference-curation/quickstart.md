...
- The progress summary prints:
  `note_counts={'candidate_intake_started': 21}`,
  `learning_point_counts={'duplicate_review': 3, 'ready': 32, 'deferred': 6}`,
  `decision_counts={'reuse_existing': 3, 'create_candidate': 32, 'status:applied': 35}`,
  `prerequisite_action_counts={'risk_review': 4, 'blocked': 1, 'deferred': 2, 'status:completed': 4, 'status:blocked': 1, 'status:deferred': 2}`,
  `risk_tier_counts={'sensitive': 44, 'ordinary': 21, 'high_risk': 4}`,
  `overlap_warning_count=9`,
  `candidate_ready_count=32`,
  `candidate_decision_count=35`,
...
- Candidate-intake decisions are applied: three decisions reuse existing
  candidates, and 32 create-candidate decisions have been applied through 013
