...
_REVIEWED_FILE_PATHS = (
    ...
    "specs/_drafts/020-liuyao-najia-engine/contracts/liuyao-v1-contract.md",
    "specs/_drafts/020-liuyao-najia-engine/data-model.md",
    "specs/_drafts/020-liuyao-najia-engine/plan.md",
    "specs/_drafts/020-liuyao-najia-engine/quickstart.md",
    "specs/_drafts/020-liuyao-najia-engine/research.md",
    "specs/_drafts/020-liuyao-najia-engine/spec.md",
    "specs/_drafts/020-liuyao-najia-engine/tasks.md",
    "src/mingli_engine/cli.py",
    "src/mingli_engine/data/liuyao/analysis_config.json",
    "src/mingli_engine/data/liuyao/batch_20260714_liuyao_family_map.json",
    "src/mingli_engine/data/liuyao/calibration/adjudication.json",
    "src/mingli_engine/data/liuyao/calibration/calibration_assertions.json",
    "src/mingli_engine/data/liuyao/calibration/calibration_cases.json",
    "src/mingli_engine/data/liuyao/calibration/reviewer_a_reviews.json",
    "src/mingli_engine/data/liuyao/calibration/reviewer_b_reviews.json",
    "src/mingli_engine/data/liuyao/gua_reference.json",
    ...
    "src/mingli_engine/liuyao/__init__.py",
    "src/mingli_engine/liuyao/analysis.py",
    "src/mingli_engine/liuyao/calendar_bridge.py",
    "src/mingli_engine/liuyao/calibration.py",
    "src/mingli_engine/liuyao/casting.py",
    "src/mingli_engine/liuyao/constants.py",
    "src/mingli_engine/liuyao/knowledge.py",
    "src/mingli_engine/liuyao/najia.py",
    "src/mingli_engine/liuyao/report.py",
    "src/mingli_engine/liuyao/report_markdown.py",
    "src/mingli_engine/liuyao/result_models.py",
    ...
    "tests/fixtures/liuyao/golden_vectors.json",
    ...
    "tests/integration/test_liuyao_cli.py",
    ...
    "tests/unit/test_liuyao_calibration.py",
    "tests/unit/test_liuyao_casting.py",
    "tests/unit/test_liuyao_constants.py",
    "tests/unit/test_liuyao_knowledge.py",
    "tests/unit/test_liuyao_najia.py",
    "tests/unit/test_liuyao_report.py",
